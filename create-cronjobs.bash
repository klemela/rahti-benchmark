...
# s3 tests disabled for now. Create a separate credentials for this and 
# find out why 4k tests are so slow
...
bash create-cronjob.bash bash-jobs/pvc-read.bash '56 * * * *'
bash create-cronjob.bash bash-jobs/pvc-write.bash '57 * * * *'
